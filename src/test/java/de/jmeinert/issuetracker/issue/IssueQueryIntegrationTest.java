...
class IssueQueryIntegrationTest {
    ...
    void findAll_filtersIssuesByProjectId() {
        ...
        IssueFilter filter = new IssueFilter(project1.getId(), null, null);
    ...
    void findAll_filtersIssuesByStatus() {
        ...
        IssueFilter filter = new IssueFilter(null, IssueStatus.IN_PROGRESS, null);
        Pageable pageable = PageRequest.of(
            0,
            20,
            Sort.by(Sort.Order.desc("createdAt"))
    ...
    void findAll_filtersIssuesByPriority() {
        ...
        IssueFilter filter = new IssueFilter(null, null, IssuePriority.MEDIUM);
        Pageable pageable = PageRequest.of(
            0,
            20,
            Sort.by(Sort.Order.desc("createdAt"))
    ...
    void findAll_returnsOnlyIssuesMatchingAllFilters() {
        ...
        IssueFilter filter = new IssueFilter(project1.getId(), IssueStatus.OPEN, IssuePriority.MEDIUM);
        Pageable pageable = PageRequest.of(
            0,
            20,
            Sort.by(Sort.Order.desc("createdAt"))
    ...
    void findAll_returnsEmptyPage_whenFilterYieldsNoResults() {
        ...
        IssueFilter filter = new IssueFilter(null, IssueStatus.CLOSED, null);
        Pageable pageable = PageRequest.of(
            0,
            20,
            Sort.by(Sort.Order.desc("createdAt"))
